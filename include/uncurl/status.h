...
enum uncurl_status {
	...
	UNCURL_ERR_NO_BODY           = -3000,
	UNCURL_ERR_MAX_CHUNK         = -3001,
	UNCURL_ERR_MAX_BODY          = -3002,
	UNCURL_ERR_MAX_HEADER        = -3003,
	UNCURL_ERR_BUFFER            = -3004,

	UNCURL_WS_ERR_STATUS         = -4000,
	UNCURL_WS_ERR_KEY            = -4001,
	UNCURL_WS_ERR_ORIGIN         = -4002,
};
