...
//XXX uncurl_read_res_body(struct uncurl_conn *ucc, char *body, uint32_t body_len);
...
//XXX uncurl_read_res_body_chunked(struct uncurl conn *ucc, char *body, uint32_t body_len);
//XXX uncurl_get_res_body_type(int32_t type, int32_t *content_length);
